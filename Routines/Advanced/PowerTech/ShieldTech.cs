        ...
        public override Composite Cooldowns
        {
            get
            {
                return new PrioritySelector(
                    ...
                    Spell.Cast("Heat Blast", ret => Me.BuffCount("Heat Screen") >= 3 || Me.Level < 50),
                    ...
                    Spell.Buff("Energy Yield", ret => Me.InCombat && Me.HealthPercent <= 70),
                    Spell.CastOnGround("Oil Slick", ret => Me.HealthPercent <= 75 && Me.Target.Distance <= 0.8f),
                ...
                return new PrioritySelector(
                    ...
                    new Decorator(ret => Me.EnergyPercent <= 40,
                        new PrioritySelector(
                            Spell.Cast("Firestorm", ret => Me.HasBuff("Flame Engine") && Me.Target.Distance <= 1f),
                    ...
                    Spell.Cast("Firestorm",
                        ret => (Me.HasBuff("Flame Engine") || Me.Level < 50) && Me.Target.Distance <= 1f),
                    Spell.Cast("Shoulder Cannon", ret => Me.HasBuff("Shoulder Cannon") && Me.Target.StrongOrGreater()),

                    //Fillers
                    Spell.Cast("Flame Burst", ret => Me.HasBuff("Flame Surge")),
                    Spell.Cast("Flame Burst", ret => Me.EnergyPercent >= 55),
                    Spell.Cast("Rapid Shots")
                    );
            }
        }
